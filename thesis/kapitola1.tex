...
$r \leq q$.
\item [Jednostránková webová aplikácia] - Je to
typ webovej stránky, ktorý načíta zo servera jednu HTML stránku a pri interakcii so stránkou sa jej 
...
zapríčíňovalo dlhšie zobrazovanie.
\end{description}
