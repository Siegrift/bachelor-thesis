...
súbežné písanie kódu viacerých používateľov. Používatelia okrem písania kódu, možu pridávať
...
študentov, ktorý následne možu úlohu riešit priamo vo webovom prehliadači.
...
\paragraph*{Keywords:} 
\begin{itemize}
  \item  Latencia - reakčný čas označújúci dobu akciu a následnou reakciou. Vo webových 
  technológiách sa pod letenciou rozumie čas, medzi poslaním webového request-u a následnej
  odpovede zo servera.
  \end{itemize}
